...
describe('Suite de test de integracion de Usuarios', () => {
    ...
    // it('Should return 200 when I sent a correct ID i params', (done) => {
    //     chai.request(app)
    //         .get('/api/v1/users/74cd6011-7e76-4d6d-b25b-1d6e4182ec2f')
    //         .set('Authorization', 'JWT eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ijc0Y2Q2MDExLTdlNzYtNGQ2ZC1iMjViLTFkNmU0MTgyZWMyZiIsImVtYWlsIjoic2FoaWQua2lja0BhY2FkZW1sby5jb20iLCJyb2wiOiJhZG1pbiIsImlhdCI6MTY2MTM5MzEyOH0.0kJgr117964rnIdw3Mu6wD5xtmlJm_z0ykJQ5M17kKc')
    //         .end((err, res) => {
